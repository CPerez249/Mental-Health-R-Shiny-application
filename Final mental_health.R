...
body <- dashboardBody(tabItems(tabItem(tabName = "Home",
                                       ...
                                       p("The code for the shiny application can be found here: instertlinktocode  As well as the paper for the research conducted on R-Shiny for Biomedical Engineering Applications: Research on the State of the Art and Proof of Concept here: instertlinktothepaper" ),
